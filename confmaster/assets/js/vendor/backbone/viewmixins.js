// filename : 'assets/js/vendor/backbone/viewmixins.js 

define(['backbone'], function(Backbone){
	
	/*
	 * EXTENDS BACKBONE BY MIXINS
	 * SRC: http://open.bekk.no/mixins-in-backbone
	 */
	var Utils = {};
	...
	/*
	Utils.modelMixin = function(from) {
	  var to = this.prototype;
	...
	*/
	...
	//Backbone.Model.mixin = Utils.modelMixin;
